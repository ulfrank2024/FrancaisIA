...
export const metadata = { title: "Conditions d'utilisation — RéussirTCF" };

export default function TermsPage() {
  return (
    <LegalLayout
      title="Conditions d'utilisation"
      subtitle="Les règles qui régissent l'utilisation de la plateforme RéussirTCF"
      icon="📋"
      ...
      <div className="space-y-10 text-slate-700 text-sm leading-relaxed">
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-2xl p-5">
          <p className="text-amber-800 font-medium">
            En créant un compte sur RéussirTCF, vous acceptez ces conditions dans leur intégralité. Si vous n'êtes pas d'accord, veuillez ne pas utiliser le service.
          </p>
        </div>

        <Section title="1. Description du service">
          <p>
            RéussirTCF est une plateforme d'apprentissage en ligne qui propose une préparation aux 4 compétences du test TCF Canada (Compréhension Orale, Compréhension Écrite, Expression Écrite, Expression Orale) via un tuteur IA nommé Sophie.
          </p>
          <p className="mt-3">
          ...
          <div className="bg-slate-50 rounded-xl p-4 mt-3">
            <p className="text-slate-600 font-medium">⚠️ RéussirTCF n'est pas affilié à France Éducation International (FEI), organisateur officiel du TCF Canada. Nous sommes un service de préparation indépendant.</p>
          </div>
        </Section>
        ...
        <Section title="4. Propriété intellectuelle">
          <p>Tous les contenus de la plateforme (questions TCF, textes, corrections IA, design, logo, code) sont la propriété exclusive de RéussirTCF Inc. ou de ses partenaires, et sont protégés par le droit d'auteur canadien.</p>
        ...
        <Section title="5. Comportement acceptable">
          <p>En utilisant RéussirTCF, vous vous engagez à :</p>
          <ul className="list-disc pl-5 space-y-1 mt-2">
        ...
        <Section title="6. Disponibilité du service">
          <p>Nous nous efforçons de maintenir une disponibilité de <strong>99,5%</strong> par mois. Des maintenances planifiées peuvent survenir, annoncées 48h à l'avance par email. RéussirTCF ne saurait être tenu responsable des interruptions dues à des facteurs hors de notre contrôle (pannes réseau, force majeure).</p>
        </Section>

        <Section title="7. Limitation de responsabilité">
          <div className="bg-slate-50 rounded-xl p-4 space-y-2">
            <p>RéussirTCF est un outil de <strong>préparation</strong> au TCF Canada. Nous ne garantissons pas un score spécifique à l'examen officiel.</p>
            <p>La responsabilité maximale de RéussirTCF Inc. est limitée au montant payé pour l'abonnement au cours des 3 derniers mois.</p>
        ...
        <Section title="8. Résiliation">
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li><strong>Par RéussirTCF</strong> : Nous pouvons suspendre ou résilier votre compte en cas de violation des présentes conditions, sans préavis</li>
            <li>Après résiliation, vos données sont supprimées conformément à notre politique de confidentialité</li>
          </ul>
        </Section>

        <Section title="9. Modifications">
          <p>RéussirTCF se réserve le droit de modifier ces conditions. Toute modification sera notifiée par email 30 jours avant son entrée en vigueur. La poursuite de l'utilisation vaut acceptation.</p>
        </Section>
