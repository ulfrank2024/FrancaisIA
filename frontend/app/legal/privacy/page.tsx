...
export const metadata = { title: 'Politique de confidentialité — FrançaisIA' };
    ...
    >
      <div className="space-y-10 text-slate-700 text-sm leading-relaxed">
        ...
        <section>
          <div className="bg-indigo-50 border border-indigo-100 rounded-2xl p-5 mb-6">
            <p className="text-indigo-800 font-medium">
              FrançaisIA s'engage à protéger la vie privée de ses utilisateurs. Cette politique explique quelles données nous collectons, pourquoi, et comment vous pouvez exercer vos droits. Elle s'applique à tous les utilisateurs de la plateforme <strong>francaisIA.ca</strong>.
            </p>
          </div>
        </section>
        ...
        <Section title="1. Responsable du traitement">
          <p>
            <strong>FrançaisIA Inc.</strong><br />
            Montréal, Québec, Canada<br />
            Email : <a href="mailto:privacy@francaisIA.ca" className="text-indigo-600 hover:underline">privacy@francaisIA.ca</a>
          </p>
        </Section>
        ...
        <Section title="6. Vos droits">
          ...
          <p className="mt-3">Pour exercer vos droits, écrivez à <a href="mailto:privacy@francaisIA.ca" className="text-indigo-600 hover:underline">privacy@francaisIA.ca</a>. Nous répondons dans un délai de <strong>30 jours</strong>.</p>
        </Section>
        ...
        <div className="bg-slate-900 text-white rounded-2xl p-6 text-center">
          ...
          <a href="mailto:privacy@francaisIA.ca" className="text-indigo-400 hover:text-indigo-300 transition-colors font-semibold">
            privacy@francaisIA.ca
          </a>
