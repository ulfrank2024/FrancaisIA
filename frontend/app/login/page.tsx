    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-cyan-50 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        >
          ...
          <p className="text-slate-500 text-center text-sm mb-6">Connecte-toi pour continuer ta préparation TCF</p>
          ...
          <p className="text-center text-sm text-slate-500 mt-6">
            ...
            <Link href="/register" className="text-indigo-600 font-semibold hover:underline">S&apos;inscrire gratuitement</Link>
          </p>
        </motion.div>
      </div>
    </div>
